...
const Navbar = () => {
  ...
  return (
    <>
      <header className="navbar">
        <div className="container navbar-container">
          <div className="navbar-logo-container">
            <button className="nav-toggle-btn">X</button>
      ...
      {/* <CartComponent setIsOpen={setIsOpen} modalIsOpen={modalIsOpen} /> */}
      <CartComponentWithRedux setIsOpen={setIsOpen} modalIsOpen={modalIsOpen} />
    </>
  );
};
